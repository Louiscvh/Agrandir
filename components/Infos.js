            ...
            <div className={styles.infosContainer} ref={infos}>
                ...
                <div className={styles.infosContent}>
                    <div className={styles.infoDetails}>
                        ...
                        <a target="_blank" rel="noreferrer"href="https://www.figma.com/file/KQXNrkJqqxjAsRN8lK3fOa/Mixologie-UX%2FUI?node-id=358%3A608" className={styles.btnPrimary}>Découvrir le site entre-aide.fr</a>
                    </div>
                </div>
            </div>
        </section>
